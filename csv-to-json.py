"""_python script to map a CSV file data field into a JSON file.
"""
# %%
...
json_file_path = './datasets/trained_data.json'
# %%
# Generate JSON file available at ./datasets/trained_data.json
